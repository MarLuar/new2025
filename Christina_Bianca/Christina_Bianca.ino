...
BLYNK_WRITE(V1) {
  ...
  if (currentTime - lastButtonPressTime > debounceDelay) {
    lastButtonPressTime = currentTime;
    if (param.asInt() == 1 && scores[ZONE_1][0] > 0) {  // Check if score > 0
...
BLYNK_WRITE(V3) {
  ...
  if (currentTime - lastButtonPressTime > debounceDelay) {
    lastButtonPressTime = currentTime;
    if (param.asInt() == 1 && scores[ZONE_1][1] > 0) {  // Check if score > 0
...
BLYNK_WRITE(V5) {
  ...
  if (currentTime - lastButtonPressTime > debounceDelay) {
    lastButtonPressTime = currentTime;
    if (param.asInt() == 1 && scores[ZONE_3][0] > 0) {  // Check if score > 0
...
BLYNK_WRITE(V7) {
  ...
  if (currentTime - lastButtonPressTime > debounceDelay) {
    lastButtonPressTime = currentTime;
    if (param.asInt() == 1 && scores[ZONE_3][1] > 0) {  // Check if score > 0
...
BLYNK_WRITE(V12) {
  ...
  if (currentTime - lastButtonPressTime > debounceDelay) {
    lastButtonPressTime = currentTime;
    if (param.asInt() == 1 && scores[ZONE_5][0] > 0) {  // Check if score > 0
      scores[ZONE_5][0]--;     // Decrement zone5 score1
      updateZoneDisplay(ZONE_5);
    }
  }
}
...
BLYNK_WRITE(V14) {
  ...
  if (currentTime - lastButtonPressTime > debounceDelay) {
    lastButtonPressTime = currentTime;
    if (param.asInt() == 1 && scores[ZONE_5][1] > 0) {  // Check if score > 0
      scores[ZONE_5][1]--;     // Decrement zone5 score2
      updateZoneDisplay(ZONE_5);
    }
  }
}
...
BLYNK_WRITE(V16) {
  ...
  if (currentTime - lastButtonPressTime > debounceDelay) {
    lastButtonPressTime = currentTime;
    if (param.asInt() == 1 && scores[ZONE_6][0] > 0) {  // Check if score > 0
      scores[ZONE_6][0]--;     // Decrement zone6 score1
      updateZoneDisplay(ZONE_6);
    }
  }
} 
...
BLYNK_WRITE(V18) {
  ...
  if (currentTime - lastButtonPressTime > debounceDelay) {
    lastButtonPressTime = currentTime;
    if (param.asInt() == 1 && scores[ZONE_6][1] > 0) {  // Check if score > 0
      scores[ZONE_6][1]--;     // Decrement zone6 score2
      updateZoneDisplay(ZONE_6);
    }
  }
}
